...
// env.PORTALESS_SQLITE_PATH (better-sqlite3); si ninguno esta presente,
// cae a memoria (nunca falla en silencio, pero no persiste entre
// restarts -- mismo principio documentado en usage-log-endpoint.js).
