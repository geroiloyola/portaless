// Helper de construccion segura de DOM para organismos del dashboard admin.
// Antes de este archivo, cada organismo interpolaba datos directo en un
// template literal y lo asignaba con node.innerHTML = html -- funciona
// mientras los datos vengan de mockData fijo, pero es una via directa de
// XSS el dia que un campo (ej. displayName de un plugin, o el nombre
// declarado por un proveedor de escrow) venga de un tercero no confiable
// y se siga tratando como HTML en vez de texto. El catalogo de plugins ya
// es abierto por defecto (ver ROADMAP.md, "Ecosistema de plugins") -- ese
// es exactamente el tipo de dato que este helper protege.
//
